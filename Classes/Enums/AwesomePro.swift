...
public struct AwesomePro {
    ...
    public enum Regular: String, Amazing, CaseIterable {
        ...
        case calendarPlusCircle = "\u{e470}"
        ...
        case church = "\u{f51d}"
        case circle = "\u{f111}"
        case circleOne = "\u{e0ee}"
        case circleTwo = "\u{e0ef}"
        case circleThree = "\u{e0f0}"
        case circleFour = "\u{e0f1}"
        case circleFive = "\u{e0f2}"
        case circleSix = "\u{e0f3}"
